  ...
  <div class="container">
    ...
    <div class="doc-content">
      ...
      <div class="span24">
        <h4>添加活动</h4>
        <hr>
       <form id="J_Form" name="form1" method="post" action="<?=base_url()?>admin/activity/edit" class="form-horizontal" enctype="multipart/form-data">

      <div class="control-group">
        <label class="control-label"><s>*</s>活动名称：</label>
        <div class="controls">
          <input name="name" type="text"  id="name" class="input-large" value="<?=$info['name']?>">
        </div>
      </div>
            <div class="control-group">
        <label class="control-label">活动轮次：</label>
        <div class="controls">
          <input name="rounds" type="text"  id="rounds" class="input-small" value="<?=$info['rounds']?>" >
        </div>
      </div>
      <div class="control-group">
        <label class="control-label">月份：</label>
        <div class="controls">
          <input name="month" type="text"  id="month" class="input-small" value="<?=$info['month']?>">
        </div>
      </div>
            <div class="control-group">
        <label class="control-label">开始时间：</label>
        <div class="controls">
          <input name="start_time" type="text"  id="start_time" class="calendar" value="<?=date("Y-m-d",$info['start_time'])?>"  >
        </div>
      </div>
      <div class="control-group">
        <label class="control-label">结束时间：</label>
        <div class="controls">
          <input name="end_time" type="text"  id="end_time" class="calendar"  value="<?=date("Y-m-d",$info['end_time'])?>">
        </div>
      </div>
            <div class="control-group">
        ...
        <div class="controls">
          <input name="num" type="text"  id="name" class="input-small" value="<?=$info['num']?>" />
        </div>
      </div>
      <div class="control-group">
        <label class="control-label">已拍份数：</label>
        <div class="controls">
          <input name="num_s" type="text"  id="name" class="input-small"  value="<?=$info['num_s']?>">
        </div>
      </div>
      <div class="control-group">
      ...
      <div class="control-group">
        ...
        <div class="controls">
          <input name="rank" type="text"  id="rank" class="input-small" value="<?=$info['rank']?>">
        </div>
      </div>
