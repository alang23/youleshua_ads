  ...
  <div class="container">
    ...
    <div class="doc-content">
      ...
      <div class="span24">
        <h4>添加订单</h4>
        <hr>
       <form id="J_Form" name="form1" method="post" action="<?=base_url()?>admin/trade/add" class="form-horizontal" enctype="multipart/form-data">
      ...
      <div class="control-group">
        ...
        <div class="controls">
          <input name="order_no" type="text"  id="order_no" class="input-large">
        </div>
      </div>
      <div class="control-group">
        <label class="control-label">买家：</label>
        <div class="controls">
          <input name="realname" type="text"  id="realname" class="input-small" >
        </div>
      </div>
      <div class="control-group">
        <label class="control-label">手机号：</label>
        <div class="controls">
          <input name="phone" type="text"  id="phone" class="input-normal">
        </div>
      </div>
      ...
      <div class="control-group">
        ...
        <div class="controls">
          <input name="price" type="text"  id="price" class="input-small">
        </div>
      </div>
