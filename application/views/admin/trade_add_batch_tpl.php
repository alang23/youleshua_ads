  ...
  <div class="container">
    ...
    <div class="doc-content">
      <ul class="breadcrumb">
          ...
          <li class="active">批量添加订单</li>
        </ul>
    </div>
      <div class="span24">
        <h4>批量添加订单</h4>
        <hr>
       <form id="J_Form" name="form1" method="post" action="<?=base_url()?>admin/trade/add_batch" class="form-horizontal" enctype="multipart/form-data">
