                          ...
                          <div class="col-sm-2 m-b-xs">
                            ...
                            <div class="col-sm-2 m-b-xs">
                                <select class="input-sm form-control input-s-sm inline" name="group_id">
                                    ...
                                    <?php
                                        foreach($channel as $admin_k => $admin_v){
                                    ?>

                                    <option value="<?=$admin_v['group_id']?>|<?=$admin_v['channel_id']?>" <?php if($group_id == ($admin_v['group_id'].'|'.$admin_v['channel_id'])){ ?> selected <?php } ?>><?=$admin_v['title']?>(<?=$admin_v['channel_id']?>)</option>
                                ...
                                <div class="input-group">
                                   <!--  <input type="text" placeholder="姓名" class="input-sm form-control" name="realname">  -->
                                    <span class="input-group-btn">
                                        <button class="btn btn-sm btn-primary" onclick="form.action='<?=base_url()?>home/agentdata/index';form.submit();"> 搜索</button> 
                                    </span>
                                </div>
                            </div>
                            <div class="col-sm-4 m-b-xs">
                                <div class="btn-group">
                                    <button class="btn btn-sm btn-primary" onclick="form.action='<?=base_url()?>home/agentdata/export';form.submit();"> 
...
<!--                                     <td><?=siyaosu($v['factor'])?></td>
 -->                                    <td><?=$v['address']?></td>
                                    ...
                                    <td><?=$v['admin_name']?></td>
                                    <td>
                                <!--     <a href="javascript:void(0);" onclick="location='<?=base_url()?>home/agentdata/add_record?id=<?=$v['id']?>';"><i class="fa fa-check text-navy"></i>添加记录</a> 
                                     |
                                     <a href="javascript:void(0);" onclick="location='<?=base_url()?>home/agentdata/edit?id=<?=$v['id']?>';"><i class="fa fa-check text-navy"></i>编辑</a> 
                                     |
                                    <a href="javascript:void(0);" onclick="alert_detail('<?=base_url()?>home/agentdata/detail?id=<?=$v['id']?>');"><i class="fa fa-check text-navy"></i> 查看</a> 
                                    |                              
                                     <a href="javascript:void(0);" onclick="flush('确定删除吗?','<?=base_url()?>home/agentdata/del?id=<?=$v['id']?>')"><i class="fa fa-check text-navy"></i> 删除</a>  -->
                                     #
                                    </td>
                                </tr>
