                                ...
                                <div class="input-group">
                                   <!--  <input type="text" placeholder="姓名" class="input-sm form-control" name="realname">  -->
                                    <span class="input-group-btn">
                                        <button class="btn btn-sm btn-primary" onclick="form.action='<?=base_url()?>home/kuaishua/flw_index';form.submit();"> 搜索</button> 
                                    </span>
                                </div>
                            </div>
                            <div class="col-sm-4 m-b-xs">
                                <div class="btn-group">
                                    <button class="btn btn-sm btn-primary" onclick="form.action='<?=base_url()?>home/kuaishua/export_customer';form.submit();"> 
...
<!--                                     <td><?=siyaosu($v['factor'])?></td>
 -->                                    <td><?=$v['address']?></td>
                                   ...
                                   <!-- <td><?=$v['frm']?></td> -->
                                    ...
                                    <a href="javascript:void(0);" onclick="alert_detail('<?=base_url()?>home/kuaishua/detail?id=<?=$v['id']?>&type=<?=$type?>');"><i class="fa fa-check text-navy"></i> 查看</a>                           
                                    </th>
                                </tr>
                                <?php 
                                  }
