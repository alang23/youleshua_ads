        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <form action="<?=base_url()?>home/standard/imports" method="post" enctype="multipart/form-data" name="form1">
                      <div class="row">
                            <div class="col-sm-3">                           
                                <div class="input-group">
                                    <input type="file" class="form-control" style="height: 35px;" name="excel"> <span class="input-group-btn"> 
                                    <input type="button" value="导入Excel" class="btn btn-primary" onclick="do_post();">
