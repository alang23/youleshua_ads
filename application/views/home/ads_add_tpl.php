                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal m-t" id="commentForm" method="post" action="<?=base_url()?>home/ads/add">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="ad_name" name="ad_name" minlength="2" type="text" class="form-control" required="" aria-required="true">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                   ...
                                   ?>
                                        <option value="<?=$adpv['id']?>"><?=$adpv['title']?></option>
                                    <?php
                                        }
                                    ?>
                                   </select>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                   ...
                                   ?>
                                        <option value="<?=$bv['b_no']?>"><?=$bv['b_name']?></option>
                                    <?php
                                        }
                                    ?>
                                   </select>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="url" type="url" class="form-control" name="url" value="http://">
                                </div>
                            </div>
                            <div class="form-group">
