            ...
            <div class="col-sm-6">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal m-t" id="commentForm" method="post" action="<?=base_url()?>home/myapp/ads_update" enctype="multipart/form-data">
                            <div class="form-group">
                                <label class="col-sm-3 control-label">位置：</label>
                                <div class="col-sm-8">
                                    <input id="ad_name" name="ad_name" minlength="2" type="text" value="<?=$info['tags_name']?>" class="form-control" >
                                </div>
                            </div>
