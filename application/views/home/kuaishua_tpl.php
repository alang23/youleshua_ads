                                ...
                                <div class="input-group">
                                   <!--  <input type="text" placeholder="姓名" class="input-sm form-control" name="realname">  -->
                                    <span class="input-group-btn">
                                        <button class="btn btn-sm btn-primary" onclick="form.action='<?=base_url()?>home/kuaishua/index';form.submit();"> 搜索</button> 
                                    </span>
                                </div>
                            </div>
                            <div class="col-sm-4 m-b-xs">
                                <div class="btn-group">
                                    <button class="btn btn-sm btn-primary" onclick="form.action='<?=base_url()?>home/kuaishua/export';form.submit();"> 
                            ...
                            ?>
                                <tr>
                                   ...
                                   <!--  <td><?=$v['card_no']?></td> 
                                    ...
                                    <td><?=$v['admin_name']?></td>
                                    <td>
                                    <a href="javascript:void(0);" onclick="alert_detail('<?=base_url()?>home/kuaishua/add_record?id=<?=$v['id']?>');"><i class="fa fa-check text-navy"></i>添加记录</a> 
                                     |
                                     <a href="javascript:void(0);" onclick="location='<?=base_url()?>home/kuaishua/edit?id=<?=$v['id']?>';"><i class="fa fa-check text-navy"></i>编辑</a> 
                                     |
                                    <a href="javascript:void(0);" onclick="alert_detail('<?=base_url()?>home/kuaishua/detail?id=<?=$v['id']?>');"><i class="fa fa-check text-navy"></i> 查看</a> 
                                    |                              
                                     <a href="javascript:void(0);" onclick="flush('确定删除吗?','<?=base_url()?>home/kuaishua/del?id=<?=$v['id']?>')"><i class="fa fa-check text-navy"></i> 删除</a> 
                                    </td>
                                </tr>
...
function fenpei()
{
      ...
      layer.confirm('分配后不可还原，确定分配吗?', {
        ...
        btn: ['确定','取消'] //按钮
            ...
            var aj = $.ajax( {
                      url:'<?=base_url()?>home/kuaishua/fenpei',
                      data:{
