            ...
            <div class="col-sm-6">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal m-t" id="commentForm" method="post" action="<?=base_url()?>home/business/add_record?id=<?=$id?>">
...
function add_record()
{
 // var re_type = $("#re_type").val();
  ...
  var aj = $.ajax( {
              url:'<?=base_url()?>home/kuaishua/add_record?id=<?=$id?>',
              data:{               
                  //re_type : re_type,
                  intro : intro,
                  msg_type : msg_type,
...
function msg_info(id)
{
  ...
  {
      case '1':
        msg = "【快刷支付】您好！感谢您选择快刷，我们客服将电话联系您确认快递地址,已便于今天安排发货，请您保持电话畅通。如您不方便接听电话，请关注公众号“优快刷”联系在线客服核实快递地址。";      
        break;
      case '2':
        msg = "【快刷支付】您好！我们客服电话联系您确认快递地址，电话未能接通，为了便于安排发货。如您不方便接听电话，请关注公众号“优快刷”联系在线客服核实快递地址。";
        break;
      case '3':
        msg = "【快刷支付】您好！刚刚我们客服电话联系您确认快递地址。如您后续想申领按键机具，请关注公众号“优快刷”并联系在线客服。";
        break;
      case '4':
        msg = "【快刷支付】您好！您快递今天会安排寄出。请关注公众号“优快刷”  输入收件人名字和电话实时查询快递进展。";
        break;
      case '5':
        msg = "【快刷支付】拉卡拉温馨提示您：您申领拉卡拉收款宝，请在签收后30自然日激活并刷满卡3000，以便您在公众号（优快刷）办理押金退还手续，过期将不再退还押金！再次感谢您选择快刷！";
        break;
