                ...
                <div class="ibox float-e-margins">
                    ...
                    <!--     <div class="">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-2 m-b-xs">
                                        <select name="p_pay" id="p_pay" class="input-sm form-control input-s-sm inline" >
                                            <option value="0" <?php if($p_pay == '0'){ ?> selected <?php } ?> >付款方式</option>
                                           <option value="1" <?php if($p_pay == '1'){ ?> selected <?php } ?> >支付宝</option>
                                           <option value="2" <?php if($p_pay == '2'){ ?> selected <?php } ?> >银行卡</option>
                                        </select>
                            </div>

                            <div class="col-sm-2 m-b-xs">
                                        <select name="dabiao" id="dabiao" class="input-sm form-control input-s-sm inline" >
                                            <option value="all" <?php if($dabiao == 'all'){ ?> selected <?php } ?> >达标状态</option>
                        ...
                        <table class="table table-striped table-bordered table-hover dataTables-example">
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?=$v['p_name']?></td>
                                    <td><?=$v['p_mobile']?></td>
                                    <td><a href="javascript:alert_detail('<?=base_url()?>home/trade/index_small?p_sn=<?=$v['p_sn']?>&show_type=small');"><?=$v['p_sn']?></a></td>
                                    ...
                                    <img src='http://app.1chuanqi.com/uploads/lkl/<?=$v['p_img']?>' width="100px"/></a>
                                    </a>
                                    </td>
                                    ...
                                    <?php
                                            ...
                                            echo !empty($v['update_time']) ? date("Y-m-d H:i:s",$v['update_time']) :'';
                                        ?>

                                    </td> 
                                    <td>
                                    <a href="<?=base_url()?>home/deal/edit_lakala?id=<?=$v['id']?>" >查看</a>|
                                    <a href="javascript:void(0);" onclick="alert_detail('<?=base_url()?>home/deal/deal_log?id=<?=$v['id']?>');" >日志</a>
                                   <!--  <a href="javascript:void(0);" onclick="flush('删除后不能恢复，确定删除吗','<?=base_url()?>home/deal/del_lakala?id=<?=$v['id']?>');">删除</a> -->
                                    </td>
                                </tr>
                                <?php
                                    }
