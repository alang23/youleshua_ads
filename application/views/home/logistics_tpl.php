                        ...
                        <div class="row">
                                ...
                                <select class="input-sm form-control input-s-sm inline" name="status">
                                    ...
                                    <option value="10" <?php if($status == '10'){?> selected <?php } ?>>提交</option>
                                     ...
                                     <option value="12" <?php if($status == '12'){?> selected <?php } ?>>问题件</option>
                                      <option value="13" <?php if($status == '13'){?> selected <?php } ?>>达标(人工)</option>
                            ...
                            <div class="col-sm-2 m-b-xs">
                                <select class="input-sm form-control input-s-sm inline" name="user_id">
                                    ...
                                    ?>
                                    <option value="<?=$uv['id']?>" <?php if($uv['id'] == $user_id){ ?> selected <?php } ?>><?=$uv['realname']?></option>
                                    <?php
                                      }
                                    ?>
                                </select>
                            ...
                            <div class="col-sm-2 m-b-xs">
                                <select class="input-sm form-control input-s-sm inline" name="kaitong">
                                    <option value="all" <?php if($kaitong == 'all'){ ?> selected <?php } ?>>开通情况</option>
                                    <option value="0" <?php if($kaitong == '0'){ ?> selected <?php } ?>>未开通</option>
                                    <option value="1" <?php if($kaitong == '1'){ ?> selected <?php } ?>>已开通</option>
                                 
                                </select>
                            </div>
                            <div class="col-sm-2 m-b-xs">
                                <select class="input-sm form-control input-s-sm inline" name="types">
                                    ...
                                    <option value="3" <?php if($types == '3'){ ?> selected <?php } ?>>18到付</option>
                                    <option value="4" <?php if($types == '4'){ ?> selected <?php } ?>>23到付</option>
                                ...
                                <div class="input-group">
                                   <!--  <input type="text" placeholder="姓名" class="input-sm form-control" name="realname">  -->
                                    <span class="input-group-btn">
                                        <button class="btn btn-sm btn-primary" onclick="form.action='<?=base_url()?>home/logistics/index';form.submit();"> 搜索</button> 
                                    </span>
                                </div>
                            </div>
                            <div class="col-sm-4 m-b-xs">
                               ...
                               <div class="btn-group">
                                    <button type="button" class="btn btn-sm btn-primary" onclick="location='<?=base_url()?>home/Logistics/imports'"></i> 导入</button> 
                               </div>

                                <div class="btn-group">
                                    <button class="btn btn-sm btn-primary" onclick="form.action='<?=base_url()?>home/logistics/export';form.submit();"> 
                                    <i class="fa fa-download"></i>
                                    导出
                                    </button> 
                               </div>
                               ...
                               <div class="btn-group">
                                    <button type="button" class="btn btn-sm btn-primary" onclick="location='<?=base_url()?>home/Logistics/add'"></i> 添加</button> 
                               </div>
                            </div>
                            </form>
                        </div>
                        ...
                        <table class="table table-striped table-bordered table-hover dataTables-example">
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?=$v['admin_name']?></td>
                                    <td><?=yajin($v['types'])?></td>
                                    <td><?=kaitong_status($v['kaitong'])?></td>
                             ...
                             <tfoot>
                              <form name="pageform" method="get" action="<?=base_url()?>home/logistics/index">
