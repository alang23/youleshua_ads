                                ...
                                <div class="input-group">
                                   <!--  <input type="text" placeholder="姓名" class="input-sm form-control" name="realname">  -->
                                    <span class="input-group-btn">
                                        <button class="btn btn-sm btn-primary" onclick="form.action='<?=base_url()?>home/business/flw_index';form.submit();"> 搜索</button> 
                                    </span>
                                </div>
                            </div>
...
<!--                                     <td><?=siyaosu($v['factor'])?></td>
 -->                                    <td><?=$v['address']?></td>
                                   ...
                                   <!-- <td><?=$v['frm']?></td> -->
                                    ...
                                    <td><?=$v['admin_name']?></td>
                                    <th>
                                    <a href="javascript:void(0);" onclick="alert_detail('<?=base_url()?>home/business/add_record?id=<?=$v['id']?>');"><i class="fa fa-check text-navy"></i>添加记录</a> 
                                     |
