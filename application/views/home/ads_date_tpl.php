                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                            <form action="<?=base_url()?>home/ads/ads_date/index" method='get'>
                                <div class="input-group">                              
                                    <input type="text" name='ad_name' placeholder="请输入关键词" class="input-sm form-control" value="<?=$ad_name?>"> 
                        ...
                        <table class="table table-striped table-bordered table-hover dataTables-example">
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?=$v['h_00']?>/<?=$v['r_00']?></td>
                                    <th>
                                        <a href="<?=base_url()?>home/ads/ads_date_view?aid=<?=$v['aid']?>&ad_name=<?=$v['ad_name']?>">更多</a>
                                    </th>
                                </tr>
