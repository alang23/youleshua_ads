            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        ...
                        <form method="get" name="form" action="<?=base_url()?>home/trade/shaixuan">
                        <div class="row">
                        ...
                        <table class="table table-striped table-bordered table-hover dataTables-example">
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?=$v['remarks']?></td>
                                    <td>
                                    <a href="javascript:void(0);" onclick="alert_detail('<?=$v['id']?>','<?=$v['remarks']?>');"> 备注</a> 
                                    </td>
                                </tr>
                                <?php
                                    }
...
function alert_detail(id,remark)
{
  //prompt层
    layer.prompt({title: '备注', value:remark,formType: 2}, function(text, index){
      layer.close(index);
      var aj = $.ajax( {
              url:'<?=base_url()?>home/trade/remarks',
              data:{
