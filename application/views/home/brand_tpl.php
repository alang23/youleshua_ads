            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <div class="">
                            <a  href="<?=base_url()?>home/brand/add" class="btn btn-primary ">添加品牌</a>
                        ...
                        <table class="table">
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?=$v['b_no']?></td>
                                    <th>
                                    <a href="<?=base_url()?>home/brand/update?id=<?=$v['id']?>">编辑</a> |
                                    <a href="javascript:void(0);" onclick="flush('删除后不能恢复，确定删除吗','<?=base_url()?>home/brand/del?id=<?=$v['id']?>');">删除</a>
                                    </th>
                                </tr>
                                <?php
                                    }
