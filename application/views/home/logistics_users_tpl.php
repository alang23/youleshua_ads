                    ...
                    <!--     <div class="">
                        ...
                        <div class="row">
                                ...
                                <div class="input-group">
                                   <!--  <input type="text" placeholder="姓名" class="input-sm form-control" name="realname">  -->
                                    <span class="input-group-btn">
                                        <button class="btn btn-sm btn-primary" onclick="form.action='<?=base_url()?>home/logistics/index_users';form.submit();"> 搜索</button> 
                                    </span>
                                </div>
                            </div>
                            <div class="col-sm-4 m-b-xs">
                               ...
                               <div class="btn-group">
                                    <button type="button" class="btn btn-sm btn-primary" onclick="location='<?=base_url()?>home/logistics/add'"></i> 增加物流记录</button> 
                               </div>
                                <div class="btn-group">
