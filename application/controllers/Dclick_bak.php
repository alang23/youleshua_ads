...
class Dclick extends BaseController
{
	...
	public function dredirect()
	{
		...
		if($aid == '93' ){
			...
			$url = "http://fanli.51huanka.com/defaults/index?frm=".$aid.'&b_no=10003';	
			redirect($url);
			exit;
		}
		...
		if($aid == '94' ){
			...
			$url = "http://fanli.51huanka.com/defaults2/index?frm=".$aid.'&b_no=10003';	
			redirect($url);
			exit;
		}
		...
		/*
		$new_aid = array('20','21','22','46','29','35','37','61','60','50','74','75','76','77','78','79','80','81','82','83','84','85','39','44','45','54','55','56','88','104','105','111');
		if(in_array($aid,$new_aid)){
			$url = 'http://app.1chuanqi.com/indexp/index';
		}else{
		...
		*/
		...
		//新页面
		// $pcmobile_id = array('106','107','108','109','110');
		// if(in_array($aid,$pcmobile_id)){
		// 	$url = 'http://app.1chuanqi.com/indexp/index';
		// }

		//关闭
		$close_ids = array('13','14','15','18','19');
		if(in_array($aid,$close_ids)){
			exit();
		}

		//力活独享
		$along_id = array('100','99','98','97','96','103');
